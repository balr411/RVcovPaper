...
p <- add_argument(p, "--PTV", help = "Include protein truncating variant group file? Options are T/F, name of file must be 
                  in format groupFilesNew/PTV/{chr}/{test}/{ref}/{trait}/{chr}.{test}.{ref}.{trait}.{gene}.PTV.group.file")
p <- add_argument(p, "--missense", help = "Include missense variant group file? Options are T/F, name of file must be 
                  in format groupFilesNew/MISSENSE/{chr}/{test}/{ref}/{trait}/{chr}.{test}.{ref}.{trait}.{gene}.MISSENSE.group.file")
